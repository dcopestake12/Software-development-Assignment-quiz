namespace Software_development_Assignment_quiz
{
    partial class Question5
    {
        ...
        private void InitializeComponent()
        {
            ...
            label1.Name = "label1";
            label1.Size = new Size(649, 15);
            label1.TabIndex = 0;
            label1.Text = "Enter the name of the device that can be hardware or software and is used to filter inbound and outbound network traffic?";
            // 
            // btnQuestion5
            // 
